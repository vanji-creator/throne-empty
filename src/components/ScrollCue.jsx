...
// Lower-centre so it never covers the phone's artwork. Pointer-events-none, so
// it can't affect page width / padding / margins on any viewport.
//
...
export default function ScrollCue() {
  return (
    <div
      data-scroll-cue
      data-on="false"
      className="pointer-events-none fixed bottom-[9vh] left-1/2 z-[40] -translate-x-1/2 opacity-0 transition-opacity duration-500 data-[on=true]:opacity-100"
      aria-hidden="true"
    >
